...
export const CARD_THEMES: Record<string, CardTheme> = {
  ...
  ocean: {
    ...
    text: "#E0F2FE",
    muted: "#7DD3FC",
    subtitleBg: "rgba(2, 30, 47, 0.85)",
    displayFont: `${FONTS.blackHanSans}, ${SYS}`,
    headingFont: `${FONTS.notoSansKR}, ${SYS}`,
    bodyFont: `${FONTS.notoSansKR}, ${SYS}`,
    spring: { damping: 18, stiffness: 100, mass: 1.0 },
  },
  sunset: {
    name: "Sunset",
    background: "#1F0F2E",
    ...
    text: "#FFF7ED",
    muted: "#FBBF77",
    subtitleBg: "rgba(31, 15, 46, 0.85)",
    displayFont: `${FONTS.jua}, ${SYS}`,
    headingFont: `${FONTS.notoSansKR}, ${SYS}`,
    bodyFont: `${FONTS.notoSansKR}, ${SYS}`,
    spring: { damping: 16, stiffness: 110, mass: 0.95 },
  },
  paper: {
    name: "Paper",
    background: "#F5F1E8",
    ...
    text: "#1F2937",
    muted: "#6B7280",
    subtitleBg: "rgba(245, 241, 232, 0.92)",
    displayFont: `${FONTS.notoSerifKR}, ${SYS}`,
    headingFont: `${FONTS.notoSerifKR}, ${SYS}`,
    bodyFont: `${FONTS.notoSansKR}, ${SYS}`,
    spring: { damping: 24, stiffness: 130, mass: 1.1 },
  },
};
